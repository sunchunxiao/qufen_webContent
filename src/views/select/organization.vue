	...
	<div class="realseCommon">
		<div class="qf-ofiicial">
			...
			<div class="qf-select">
				...
				<span class="progress-per">机构号</span>
			</div>
		</div>
		<div class="realseContent">
			...
			<div>
				...
				<Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
					...
					<FormItem label="认证信息" prop="message">
						<Input v-model="formValidate.message" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="示例：区分FIND官方账号请不要使用修饰性词汇，例如：最大最好。不要超过30个"></Input>
					</FormItem>
			...
			<div>
				...
				<Form ref="formValidate" :model="qiye" :rules="ruleValidate" :label-width="80">
					...
					<FormItem label="认证公函" prop="photo">
						<span class="please color">下载填写<span class="applyOfficial"><a href="https://pic.qufen.top/%E5%AE%98%E6%96%B9%E8%AE%A4%E8%AF%81%E9%80%9A%E7%94%A8%E7%94%B3%E8%AF%B7%E5%85%AC%E5%87%BD%28%E6%9C%BA%E6%9E%84%E5%8F%B7%29.docx">《官方认证通用申请公函》</a></span>，填写完成后加盖红色公章，请上传清晰的公函扫描件(图片)。</span>
					</FormItem>
	...
	export default {
		...
		methods: {
			...
			next() {
				...
				} else if(this.formValidate.message.length > 30) {
					this.$alert('认证信息不能超过30个字', {
						confirmButtonText: '确定',
					});
				} else if(this.formValidate.message == '') {
					this.$alert('请填写认证信息', {
						confirmButtonText: '确定',
					});
				...
				//				} 
					...
					setTimeout(() => {
						let data = {
							...
							//认证信息
							authinformation: this.formValidate.message,
							//企业名称
