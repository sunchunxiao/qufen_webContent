...
Toolbar = (function(superClass) {
  ...
  Toolbar.prototype._init = function() {
    ...
    if (!$.isArray(this.opts.toolbar)) {
      this.opts.toolbar = ['bold', 'italic', 'underline', 'strikethrough', '|', 'ol', 'ul', 'blockquote', 'code', '|', 'link', 'image', '|', 'indent', 'outdent','alignment'];
    }
    this._render();
...
//    	localStorage.setItem("imgurl",file.name.split(".")[1])
...
//      	console.log(result)
        	var a = "https://pic.qufen.top/"+result.key
        	$img.attr('src',a)
  ...
  ImagePopover.prototype._initUploader = function() {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return _this.input = $('<input name="file"/>', {
          type: 'file',
          name:'file',
          title: _this._t('uploadImage'),
          multiple: true,
